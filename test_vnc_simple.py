#!/usr/bin/env python3
"""
Script simple para probar VNC con Selenium
"""
...
def test_vnc():
    print("🔧 Iniciando prueba de VNC...")
    
    # Configuración mínima para VNC
    ...
    try:
        ...
        print("⏳ Esperando 15 segundos para que veas en VNC...")
        ...
        search_box.send_keys("Selenium VNC Test")
